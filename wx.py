...
# 从测试号信息获取
appID = "wxad969810113d6a41"
appSecret = "78deeaf3b05e6c009607870b8da43c05"
#收信人ID即 用户列表中的微信号，见上文
openId = "ov0Bk6XgMexrUW2apwNx0m2WCxZg"
# 天气预报模板ID
weather_template_id = "2GWJ5aWzgM6b3B83GPO0cxbqjTEhRSoTb7NGzku6Kio"
# 时间表模板ID
timetable_template_id = "jhWyg3Zfv4XKeZNbxde2xsDR-kujdm84YpmaG4zgHa8"
...
if __name__ == '__main__':
    ...
    schedule.every().day.at("06:30").do(weather_report, "马鞍山")
    schedule.every().day.at("06:30").do(timetable, "该起床了")
    schedule.every().day.at("06:45").do(timetable, "你还不起床是吧?是不是不想要考研了！！快点给老子背英语")

    schedule.every().day.at("07:45").do(timetable, "应该要到图书馆了吧，快点哦！！")
    schedule.every().day.at("08:00").do(timetable, "图书馆了吧，没到的话估计考研就悬了")

    schedule.every().day.at("09:00").do(timetable, "如果你是在学习，那你是真的棒！！")

    schedule.every().day.at("00:15").do(timetable, "已经很晚了，该睡觉了，明天还要早起背单词！")
